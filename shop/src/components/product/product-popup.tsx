      ...
      <div className="flex flex-col lg:flex-row w-full md:w-[650px] lg:w-[960px] mx-auto overflow-hidden">
        ...
        <div className="flex flex-col p-5 md:p-8 w-full">
          ...
          <div className="pt-2 md:pt-4">
            ...
            <div className="row item-center flex mt-4 mb-2">
              <h4 className="text-black mx-auto">Want to shop at our marketplace?</h4>
            </div>
            <div className="row item-center flex px-5 ">
              <Link href={`${(product.shopee)}`}>
                <a target="_blank" className="mx-auto">
                  <Marketplace
                  marketplace="shopee"
                  type="button"
                  >
                    <img src="http://localhost/hijra-verse/shop/public/icons/shopee.png" className="shopee" />
                  </Marketplace>
                </a>
              </Link>
              {/* <Link href={`${(product.lazada)}`}>
                <Marketplace
                marketplace="lazada"
                type="button"
                >
                  <img src="http://localhost/hijra-verse/shop/public/icons/lazada.png" className="lazada" />
                </Marketplace>
              </Link>
              <Link href={`${(product.tokopedia)}`}>
                <Marketplace
                marketplace="tokopedia"
                type="button"
                >
                  <img src="http://localhost/hijra-verse/shop/public/icons/tokopedia.png" className="tokopedia" />
                  <img src="http://localhost/hijra-verse/shop/public/icons/text-tokopedia.png" className="text-tokopedia" />
                </Marketplace>
              </Link> */}
            </div>
