...
import {
  shahamaHomeHeroGridSlider as heroBanner,
  homeEightCoupons,
  shahamaSaleBannerWithProducts,
  shahamaSaleBannerData,
  shahamaSaleBannerDataGallery
...
export { getStaticProps } from "@framework/ssr/homepage/shahama";
    ...
    <>
        ...
        <ProductSearchBlock />
          ...
          {/* <SaleBannerWithProducts
            ...
            imageWidth={275}
            limit={8}
            bannerData={shahamaSaleBannerWithProducts}
          /> */}
          ...
          {/* <BannerCarouselBlock banners={shahamaSaleBannerDataGallery} /> */}
