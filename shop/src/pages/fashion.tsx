...
import {
  samaseHomeHeroGridSlider as heroBanner,
  homeEightCoupons,
  samaseSaleBannerWithProducts,
  samaseSaleBannerData,
  samaseSaleBannerDataGallery
...
export { getStaticProps } from "@framework/ssr/homepage/samase";
    ...
    <>
        <Container>
          ...
          <SaleBannerWithProducts
            ...
            imageWidth={275}
            limit={8}
            bannerData={samaseSaleBannerWithProducts}
          />
          ...
          <BannerCarouselBlock banners={samaseSaleBannerDataGallery} />
